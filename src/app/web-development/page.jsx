...
import { FAQsData, PriceData, ProcessData, ServicesData, CtaData, CallActionData, ChooseUsData, IndustriesData, BannerData, TestimonialData } from '@/src/app/web-development/data/data';
