//Banner
import BannerPoster from "media/innerservices/local-seo/bannerImg.webp"

export const BannerData = {
    title: "Dominate Local Search Engine Rankings Today",
...
//Content Data
import ContentImg from "media/innerservices/local-seo/Img01.webp"

export const ContentData = {
    maintitle: true,
    contentTitle: "Why Local SEO Is Key For You",
    contentTxt: (<>
        <p>Local SEO is the secret to boosting your business’s visibility within your community. By optimizing your online presence for local searches, we ensure that potential customers can find you easily.</p>
        <p> Whether it’s on Google Maps or local search results, your business will stand out. Let’s boost your local presence today!</p>
    </>),
    img: ContentImg.src
}

//Content Data
import ContentImg1 from "media/innerservices/local-seo/Img02.webp"
    ...
    ProcessItem1: [
        {
            ...
            txt: (<>
                ...
                <p>Enhance your profile for better local visibility.</p>
        ...
        },
        {
            ...
            txt: (<>
                ...
                <p>Optimize for essential local keywords.</p>
                <strong>Long-Tail Keywords:</strong>
                <p>We focus on hyper-targeted, long-tail keywords to capture specific local searchers’ intent.</p>
                <strong>Focus on Community Terms:</strong>
                <p>We incorporate community-specific terms to make sure you show up where it counts most.</p>
            </>),
    ...
    ProcessItem2: [
        {
            ...
            txt: (<>
                ...
                <p>Ensure accuracy to boost local trust and traffic.</p>
            </>),
            ...
            txt: (<>
                ...
                <p>Gain backlinks and recognition through local events.</p>
            </>),
    ...
    ProcessItem3: [
        {
            ...
            txt: (<>
                ...
                <p>Simplify how locals can reach you on mobile.</p>
            </>),
        ...
        },
        {
            ...
            txt: (<>
                ...
                <p>Enhance engagement on local social platforms.</p>
                <strong>Promote Local Content: </strong>
                <p>Share content that resonates with local interests.</p>
                <strong>Monitor Local Feedback:</strong>
                <p>Stay responsive to community feedback on social media.</p>
            </>),
...
export const WorkData = {
    ...
    title: "Explore Our Successful Local SEO Projects",
    desc: "Discover how Infinitidigital’s tailored local SEO strategies helped businesses like yours shine. Our results speak for themselves!",
    WorkItem: [
        {
            title: "Music App",
...
export const PriceData = {
    ...
    title: "Discover Our Transparent Local SEO Pricing Plans",
    desc: "At Infinitidigital, we offer affordable, customizable pricing for our local SEO services, tailored to meet your business’s unique needs. Explore our competitive and customized pricing to help your business thrive in local search results!",
    PriceItem: [
        {
            bgColor: "#7635FF",
